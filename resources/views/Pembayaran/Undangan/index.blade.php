  ...
  <div class="row align-items-center">
    <div class="col-md-7">
      <div class="form-group">
        ...
        <select name="pesanan_id" endpoint="{{route('pesanan.select2')}}" class="select2 pesanan_id form-control  @error('pesanan_id') is-invalid @enderror" id="pesanan_id">
        </select>
        @error("pesanan_id")
  ...
  <div class="row">
    ...
    <div class="col-md-5">
      <div class="card border-top-primary" id="elBayar">
        ...
        <div class="card-body">
          <form action="{{route('pembayaran.undangan','xxxxme')}}" method="post">
            @csrf
  ...
  <script>
    $(document).ready(function() {
      const select2Pesanan = $(".select2.pesanan_id").select2({
        placeholder: "Cari No Pesanan / Nama Pelanggan / email Pelanggan / Alamat /  Nama Undangan / Kode Undangan / Nama Pelanggan",
        ...
        ajax: {
          ...
          processResults: function(data) {
            let results = data.data.map(pesanan => {
              pesanan.text = pesanan.text || pesanan.no_pesanan + " | [" + pesanan.undangan.nama_undangan + "|" + pesanan.undangan.kode_undangan + "]";
              return {
